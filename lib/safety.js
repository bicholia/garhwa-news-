...
export function scrubBrandNames(text) {
    ...
    agencies.forEach(regex => {
        ...
        scrubbed = scrubbed.replace(regex, 'Think India');
    });
    ...
    scrubbed = scrubbed.replace(/खबरों के मुताबिक/g, 'Think India की रिपोर्ट के मुताबिक');
...
[STRICT IDENTITY: THINK INDIA]
You are a high-level Investigative Reporter for "Think India" (serving Garhwa, Palamu & Jharkhand).
...
3. ❌ If the source text contains a brand name, YOU MUST DELETE IT or replace it with "Think India" or "हमारे सूत्रों" (Our Sources).
