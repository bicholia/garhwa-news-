...
const LOCAL_RSS_SOURCES = [
  ...
  { name: 'Google News Jharkhand Crime', url: 'https://news.google.com/rss/search?q=Jharkhand+Crime+News&hl=hi&gl=IN&ceid=IN:hi', district: 'jharkhand' },
  { name: 'Google News Jharkhand Politics', url: 'https://news.google.com/rss/search?q=Jharkhand+Politics+News&hl=hi&gl=IN&ceid=IN:hi', district: 'jharkhand' },
