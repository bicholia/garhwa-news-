...
export const metadata: Metadata = {
    title: 'हमारे बारे में | थिंक इंडिया न्यूज़',
    description:
        'थिंक इंडिया न्यूज़ - गढ़वा और पलामू जिले की सबसे तेज और भरोसेमंद हिंदी समाचार वेबसाइट। जानिए हमारी टीम, मिशन और विजन के बारे में।',
    keywords: 'गढ़वा समाचार, पलामू न्यूज़, झारखंड हिंदी न्यूज़, स्थानीय पत्रकारिता',
    openGraph: {
        title: 'हमारे बारे में | थिंक इंडिया न्यूज़',
        description: 'थिंक इंडिया न्यूज़ - गढ़वा और पलामू की आवाज',
    },
}
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 mt-4 font-semibold">
                            गढ़वा-पलामू का अपना डिजिटल न्यूज़ नेटवर्क — <span className="text-red-600">Think India</span>
                        </p>
                    </div>
                        ...
                        <div className="md:flex">
                            ...
                            <div className="md:w-2/3 p-10">
                                ...
                                <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                                    Think India की शुरुआत एक छोटे से सपने के साथ हुई थी — गढ़वा और पलामू जैसे क्षेत्रों में सूचना के अभाव को मिटाना। हमने देखा कि हमारे क्षेत्र की खबरें बड़े मीडिया हाउसों में कहीं खो जाती थीं।
                                </p>
                                <p className="text-gray-700 leading-relaxed mb-6 text-lg">
