...
const POSTS_PER_PAGE = 20 // High density matching NDTV
        ...
        <PublicLayout>
            <div className="bg-white min-h-screen">
                        ...
                        <aside className="lg:col-span-3 space-y-10">
                            ...
                            <div className="bg-[#F8F8F8] p-6 rounded-sm border-t-4 border-brand-red">
                                ...
                                <div className="space-y-4">
                                    {['Garhwa Development', 'Palamu Updates', 'Jharkhand Schemes', 'Crime Watch'].map((tag, i) => (
                ...
                <div className="container pb-12">
                    <AdBanner slot="district_bottom" width={970} height={90} />
                </div>
            </div>
        </PublicLayout>
    )
