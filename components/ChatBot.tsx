  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-24 lg:bottom-6 right-4 w-14 h-14 rounded-full bg-white border border-brand-red shadow-xl hover:scale-105 transition-all z-[3000] flex items-center justify-center p-2 group ${isOpen ? 'scale-0' : 'scale-100'}`}
      ...
      {/* Chat Window */}
      <div 
        className={`fixed bottom-24 lg:bottom-6 right-4 w-[calc(100vw-32px)] sm:w-96 h-[500px] max-h-[70vh] bg-white rounded-2xl shadow-2xl flex flex-col z-[3000] transition-all origin-bottom-right border border-gray-200 overflow-hidden ${isOpen ? 'scale-100 opacity-100' : 'scale-0 opacity-0 pointer-events-none'}`}
      >
        {/* Header */}
